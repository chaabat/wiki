...
<body>
                        ...
                        <form action="" method="post" >
                            ...
                            <div class="divide-y divide-yellow-200">
                                <div class="py-8 text-base leading-6 space-y-4 text-black-700 sm:text-lg sm:leading-7">
                                    <div class="relative">
                                        <input autocomplete="off" id="name" name="name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-yellow-300 text-black-900 focus:outline-none focus:borer-rose-600" placeholder="Enter your surname" required/>
                                    ...
                                    <div class="relative">
                                        <input autocomplete="off" id="username" name="username" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-yellow-300 text-black-900 focus:outline-none focus:borer-rose-600" placeholder="Enter your username" required/>
                                    ...
                                    <div class="relative">
                                        <input autocomplete="off" id="picture" name="picture" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-yellow-300 text-black-900 focus:outline-none focus:borer-rose-600" placeholder="Enter your phone number" required />
                                    ...
                                    <div class="relative">
                                        <input autocomplete="off" id="password" name="password" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-yellow-300 text-black-900 focus:outline-none focus:borer-rose-600" placeholder="Password" required/>
    ...
    <script src="../../public/js/registre.js">
