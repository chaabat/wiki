  <div class="flex flex-col sm:w-56 bg-[#0466c8] overflow-hidden">
      <div class="flex items-center justify-center h-[200px]  shadow-md">
          <img class=" rounded-[900px]" src="../../../public/img/admin.png" alt="">
      ...
      <ul class="flex flex-col py-4">
          ...
          <li>
              <a href="categories.php" class="flex flex-row hover:bg-[#03045e] items-center h-12 ">
          ...
          <li>
              <a href="tags.php" class="flex flex-row hover:bg-[#03045e] items-center h-12 ">
