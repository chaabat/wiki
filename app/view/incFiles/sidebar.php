   <!-- Sidebar -->
   <div class="flex flex-col sm:w-56 bg-[#3a86ff] overflow-hidden">
            ...
            <ul class="flex flex-col py-4">
                <li>
                    <a href="dashboard.php" class="flex flex-row hover:bg-white hover:text-black  items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="categories.php" class="flex flex-row hover:bg-white items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">Categories</span>
                    </a>
                </li>
                <li>
                    <a href="tags.php" class="flex flex-row hover:bg-white items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">tags</span>
                    </a>
                </li>
                <li>
                    <a href="../index.php" class="flex flex-row hover:bg-white items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">Wikis</span>
                    </a>
                </li>
                <!-- <li>
                    <a href="#" class="flex flex-row items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">Profile</span>
                    </a>
                </li> -->
                <!-- <li>
                    <a href="#" class="flex flex-row items-center h-12 ">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-white-400"><i class="bx bx-bell"></i></span>
                        <span class="text-xl font-large text-white hover:text-black">Notifications</span>
                ...
                <li>
                    <a href="./dashboard.php?deconn" class="flex flex-row hover:bg-white items-center h-12 ">
                        ...
                        <span class="text-xl font-large text-white hover:text-black">Logout</span>
                    </a>
                </li>
            </ul>
