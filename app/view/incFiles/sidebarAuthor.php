   <div class="flex flex-col sm:w-56 bg-[#0466c8] overflow-hidden">
            <div class="flex items-center justify-center h-[200px]  shadow-md">
            <img class=" " src="../../../public/img/author.png" alt="">
            ...
            <ul class="flex flex-col py-4">
                ...
                <li>
                    <a href="wikis.php" class="flex flex-row hover:bg-[#03045e] items-center h-12 ">
                        ...
                        <span class="text-lm font-bold  text-white">My Wikis</span>
                    </a>
                </li>
                <li>
                    <a href="../../../index.php" class="flex flex-row hover:bg-[#03045e] items-center h-12 ">
                        ...
                        <span class="text-lm font-bold  text-white">All Wikis</span>
                    </a>
                </li>
                
              
                <li>
                    <a href="./wikis.php?deconn" class="flex flex-row hover:bg-[#03045e] items-center h-12 ">
