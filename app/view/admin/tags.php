                            ...
                            <?php foreach ($tags as $t) : ?>
                                ...
                                <div class="flex flex-col items-center justify-around bg-white overflow-hidden shadow sm:rounded-lg h-full p-2">
                                    ...
                                    <div class="flex items-center gap-6">
                                        <a href="#" title="Edit" class="editTagButton" data-tag-id="<?php echo $t->getTagID(); ?>" data-tag-name="<?php echo $t->getTag(); ?>" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                                        ...
                                        <a title="delete" href="tags.php?deletetag&tagID=<?php echo $t->getTagID(); ?>">
